...
# Data pulled from the Penguin Random House website: https://www.penguinrandomhouse.com/
...
c_hiaasen = CreateAuthor("Hiaasen", "Carl", "CARL HIAASEN was born and raised in Florida. He is the author of thirteen previous novels, including the best sellers Razor Girl, Bad Monkey, Star Island, Nature Girl, Skinny Dip, Sick Puppy, and Lucky You, and five best-selling children’s books, Hoot, Flush, Scat, Chomp, and Skink. His most recent work of nonfiction is Dance of the Reptiles, a collection of his columns from The Miami Herald. www.carlhiaasen.com. CARL HIAASEN is available for select readings and lectures.").__dict__
...
d_seuss = CreateAuthor("Seuss", "Dr.", "Theodor Seuss Geisel—aka Dr. Seuss—is one of the most beloved children’s book authors of all time. From The Cat in the Hat to Oh, the Places You’ll Go!, his iconic characters, stories, and art style have been a lasting influence on generations of children and adults. The books he wrote and illustrated under the name Dr. Seuss (and others that he wrote but did not illustrate, including some under the pseudonyms Theo. LeSieg and Rosetta Stone) have been translated into 30 languages. Hundreds of millions of copies have found their way into homes and hearts around the world. Dr. Seuss’s long list of awards includes Caldecott Honors for McElligot’s Pool, If I Ran the Zoo, and Bartholomew and the Oobleck; the Pulitzer Prize; and eight honorary doctorates. Works based on his original stories have won three Oscars, three Emmys, three Grammys, and a Peabody.").__dict__
author_catalog.append(d_seuss)

j_slate = CreateAuthor("Slate", "Jenny", "Jenny Slate is a writer, comedian, and actress. She and Dean Fleischer-Camp created the short film Marcel the Shell with Shoes On in the late summer of 2010. It screened at film festivals all over the world, including Sundance and the New York International Children’s Film Festival, where it won the Grand Jury and Audience Awards. It subsequently became a viral sensation, garnering more than 20 million views on YouTube. Their first picture book, Marcel the Shell with Shoes On: Things About Me, was a New York Times bestseller. Slate has appeared in numerous films and TV programs, including Obvious Child, Saturday Night Live, Parks and Recreation, and Zootopia.").__dict__
author_catalog.append(j_slate)

d_camp = CreateAuthor("Fleischer-Camp", "Dean", "Dean Fleischer-Camp is a writer, director, and artist. He and Jenny Slate created the short film Marcel the Shell with Shoes On in the late summer of 2010. It screened at film festivals all over the world, including Sundance and the New York International Children’s Film Festival, where it won the Grand Jury and Audience Awards. It subsequently became a viral sensation, garnering more than 20 million views on YouTube. Their first picture book, Marcel the Shell with Shoes On: Things About Me, was a New York Times bestseller.").__dict__
author_catalog.append(d_camp)

j_baldwin = CreateAuthor("Baldwin", "James", "James Baldwin (1924–1987) was a novelist, essayist, playwright, poet, and social critic. His first novel, Go Tell It on the Mountain, appeared in 1953 to excellent reviews, and his essay collections Notes of a Native Son and The Fire Next Time were bestsellers that made him an influential figure in the growing civil rights movement. Baldwin spent much of his life in France, where he moved to escape the racism and homophobia of the United States. He died in France in 1987, a year after being made a Commander of the French Legion of Honor.").__dict__
...
m_crichton = CreateAuthor("Crichton", "Michael", "Michael Crichton was a writer, director, and producer, best known as the author of Jurassic Park and the creator of ER. One of the most recognizable names in literature and entertainment, Crichton sold more than 200 million copies of his books, which have been translated into 40 languages and adapted into 15 films. He died in 2008.").__dict__
author_catalog.append(m_crichton)

e_cline = CreateAuthor("Cline", "Ernest", "Ernest Cline is an internationally best-selling novelist, screenwriter, father, and full-time geek. He is the #1 New York Times best-selling author of the novels Ready Player One and Armada, and co-screenwriter of the blockbuster film adaptation of Ready Player One, directed by Steven Spielberg.  His books have been published in over fifty countries and have spent more than 100 weeks on The New York Times Best Sellers list.  He lives in Austin, Texas, with his family, a time-traveling DeLorean, and a large collection of classic video games.").__dict__
author_catalog.append(e_cline)

a_weir = CreateAuthor("Weir", "Andy", "Andy Weir built a career as a software engineer until the success of his first published novel, THE MARTIAN, allowed him to live out his dream of writing fulltime. He is a lifelong space nerd and a devoted hobbyist of subjects such as relativistic physics, orbital mechanics, and the history of manned spaceflight. He also mixes a mean cocktail. He lives in California.").__dict__
author_catalog.append(a_weir)

m_maron = CreateAuthor("Maron", "Marc", "Marc Maron is a stand-up comedian and host of the podcast WTF with Marc Maron. He has appeared in his own comedy specials on Comedy Central and HBO, and his sitcom Maron airs on IFC. He lives in Los Angeles.").__dict__
author_catalog.append(m_maron)

k_vonnegut = CreateAuthor("Vonnegut", "Kurt", "Kurt Vonnegut was a master of contemporary American literature. His black humor, satiric voice, and incomparable imagination first captured America’s attention in The Sirens of Titan in 1959 and established him, in the words of The New York Times, as “a true artist” with the publication of Cat’s Cradle in 1963. He was, as Graham Greene declared, “one of the best living American writers.” Mr. Vonnegut passed away in April 2007.").__dict__
author_catalog.append(k_vonnegut)

z_smith = CreateAuthor("Smith", "Zadie", "Zadie Smith is the author of the novels White Teeth, The Autograph Man, On Beauty, NW and Swing Time, as well as a novella, The Embassy of Cambodia, and a collection of essays, Changing My Mind. She is also the editor of The Book of Other People. Zadie was elected a fellow of the Royal Society of Literature in 2002, and was listed as one of Granta’s 20 Best Young British Novelists in 2003 and again in 2013. White Teeth won multiple literary awards including the James Tait Black Memorial Prize, the Whitbread First Novel Award and the Guardian First Book Award. On Beauty was shortlisted for the Man Booker Prize and won the Orange Prize for Fiction, and NW was shortlisted for the Baileys Women’s Prize for Fiction. Zadie Smith is currently a tenured professor of fiction at New York University and a Member of the American Academy of Arts and Letters.").__dict__
author_catalog.append(z_smith)

c_achebe = CreateAuthor("Achebe", "Chinua", "Chinua Achebe was born in Nigeria in 1930. His first novel, Things Falls Apart, became a classic of international literature and required reading for students worldwide. He also authored four subsequent novels, two short-story collections, and numerous other books. He was the David and Marianna Fisher University Professor and Professor of Africana Studies at Brown University and, for more than 15 years, was the Charles P. Stevenson Jr. Professor of Languages and Literature at Bard College. In 2007, Achebe was awarded the Man Booker International Prize for lifetime achievement. He died in 2013.").__dict__
author_catalog.append(c_achebe)

g_vidal = CreateAuthor("Vidal", "Gore", "Gore Vidal (1925–2012) was born at the United States Military Academy at West Point. His first novel, Williwaw, written when he was 19 years old and serving in the army, appeared in the spring of 1946. He wrote 23 novels, five plays, many screenplays, short stories, well over 200 essays, and a memoir.").__dict__
author_catalog.append(g_vidal)

n_macdonald = CreateAuthor("Macdonald", "Norm", "Norm Macdonald is a stand-up comedian, writer, and actor who lives in Los Angeles. He is the proud father of Devery.From the Hardcover edition.").__dict__
author_catalog.append(n_macdonald)

g_watsky = CreateAuthor("Watsky", "George", "George Watsky is a writer and musician from San Francisco, California. After getting his start as a teenager in competitive poetry slam, winning both the Youth Speaks Slam and Brave New Voices National Poetry Slam at the Apollo Theater, he has since branched out into hip hop and long-form writing. Watsky has performed on HBO’s Russell Simmons Presents Def Poetry, the Ellen Show, the NAACP Image Awards, and his online videos have received hundreds of millions of YouTube hits. A committed live performer, he’s played hundreds of shows, both with his band and solo, across the North America, Europe, Australia, and India, including festival slots at San Francisco’s Outside Lands, Just for Laughs in Montreal, Rock the Bells, Soundset, Warped Tour, and released numerous music albums and mixtapes, including his most recent projects, 2013’s “Cardboard Castles” and 2014’s “All You Can Do.” He graduated from Emerson College with a degree in acting and dramatic writing, where he received the Rod Parker playwriting fellowship, and released a poetry collection, “Undisputed Backtalk Champion,” on First Word Press way back in 2006. And although he was forced to write a lot essays in school, he considers this his first attempt at prose.").__dict__
author_catalog.append(g_watsky)

p_robinson = CreateAuthor("Robinson", "Phoebe", "Phoebe Robinson is a stand-up comedian, actress, and the author of the New York Times bestseller You Can’t Touch My Hair. Most recently, she and Jessica Williams turned their hit WNYC Studios podcast, 2 Dope Queens, into four one-hour HBO specials. Robinson has also appeared on The Late Show with Stephen Colbert, Late Night with Seth Meyers, Conan, Broad City, Search Party, The Daily Show, and the Today show; she was also a staff writer on the final season of Portlandia. When not working in TV, she’s the host of the critically acclaimed WNYC Studios interview podcast Sooo Many White Guys. She recently made her feature film debut in the Netflix comedy Ibiza, released earlier this year.").__dict__
...
this_is_not_my_hat = CreateBook("This Is Not My Hat", "https://images.penguinrandomhouse.com/cover/9780763655990", "From the creator of the #1 New York Times best-selling and award-winning I Want My Hat Back comes a second wry tale.<br/>When a tiny fish shoots into view wearing a round blue topper (which happens to fit him perfectly), trouble could be following close behind. So it’s a good thing that enormous fish won’t wake up. And even if he does, it’s not like he’ll ever know what happened. . . . Visual humor swims to the fore as the best-selling Jon Klassen follows his breakout debut with another deadpan-funny tale.").__dict__
this_is_not_my_hat['authors'].append({"last_name": j_klassen['last_name'], "first_name": j_klassen['first_name']})
this_is_not_my_hat['genres'].append({"type": g_children_picture['type']})
book_catalog.append(this_is_not_my_hat)

we_found_a_hat = CreateBook("We Found a Hat", "https://images.penguinrandomhouse.com/cover/9780763656003", "Hold on to your hats for the conclusion of the celebrated hat trilogy by Caldecott Medalist Jon Klassen, who gives his deadpan finale a surprising new twist.<br/>Two turtles have found a hat. The hat looks good on both of them. But there are two turtles. And there is only one hat. . . . Evoking hilarity and sympathy, the shifting eyes tell the tale in this brilliantly paced story in three parts, highlighting Jon Klassen’s visual comedy and deceptive simplicity. The delicious buildup takes an unexpected turn that is sure to please loyal fans and newcomers alike.").__dict__
we_found_a_hat['authors'].append({"last_name": j_klassen['last_name'], "first_name": j_klassen['first_name']})
we_found_a_hat['genres'].append({"type": g_children_picture['type']})
book_catalog.append(we_found_a_hat)

sam_and_dave_dig_a_hole = CreateBook("Sam and Dave Dig a Hole", "https://images.penguinrandomhouse.com/cover/9780763662295", "With perfect pacing, the multi-award-winning, New York Times best-selling team of Mac Barnett and Jon Klassen dig down for a deadpan tale full of visual humor.<br/>Sam and Dave are on a mission. A mission to find something spectacular. So they dig a hole. And they keep digging. And they find . . . nothing. Yet the day turns out to be pretty spectacular after all. Attentive readers will be rewarded with a rare treasure in this witty story of looking for the extraordinary — and finding it in a manner you’d never expect.").__dict__
sam_and_dave_dig_a_hole['authors'].append({"last_name": j_klassen['last_name'], "first_name": j_klassen['first_name']})
sam_and_dave_dig_a_hole['authors'].append({"last_name": m_barnett['last_name'], "first_name": m_barnett['first_name']})
sam_and_dave_dig_a_hole['genres'].append({"type": g_children_picture['type']})
book_catalog.append(sam_and_dave_dig_a_hole)

square = CreateBook("Square", "https://images.penguinrandomhouse.com/cover/9780763696078", "The beguiling second entry in the innovative shape trilogy by multi-award-winning, New York Times best-selling duo Mac Barnett and Jon Klassen.<br/>This book is about Square. Square spends every day taking blocks from a pile below the ground to a pile above the ground. This book is also about Square’s friend Circle. Circle thinks Square is an artistic genius. But is he really? With the second story in a trilogy of tales about Triangle, Square, and Circle, Mac Barnett and Jon Klassen nudge readers toward a more well-rounded way of looking at things. Understated and striking in its simplicity, this funny, thoughtful offering from two of today’s most talented picture-book creators emphasizes the importance of keeping your eyes — and your mind — open to wonder where others see only rubble and rocks.").__dict__
square['authors'].append({"last_name": j_klassen['last_name'], "first_name": j_klassen['first_name']})
square['authors'].append({"last_name": m_barnett['last_name'], "first_name": m_barnett['first_name']})
square['genres'].append({"type": g_children_picture['type']})
book_catalog.append(square)

i_want_my_hat_back = CreateBook("I Want My Hat Back", "https://images.penguinrandomhouse.com/cover/9780763655983", "A picture-book delight by a rising talent tells a cumulative tale with a mischievous twist.<br/>The bear’s hat is gone, and he wants it back. Patiently and politely, he asks the animals he comes across, one by one, whether they have seen it. Each animal says no, some more elaborately than others. But just as the bear begins to despond, a deer comes by and asks a simple question that sparks the bear’s memory and renews his search with a vengeance. Told completely in dialogue, this delicious take on the classic repetitive tale plays out in sly illustrations laced with visual humor— and winks at the reader with a wry irreverence that will have kids of all ages thrilled to be in on the joke.").__dict__
i_want_my_hat_back['authors'].append({"last_name": j_klassen['last_name'], "first_name": j_klassen['first_name']})
i_want_my_hat_back['genres'].append({"type": g_children_picture['type']})
book_catalog.append(i_want_my_hat_back)


up_and_down = CreateBook("Up and Down", "https://images.penguinrandomhouse.com/cover/9780399257377", "A penguin has wings for a reason . . . doesn’t he? Having a best friend with his own airplane is one thing, but actually experiencing what it feels like to fly by himself? Here is one penguin who believes this is precisely what he needs to feel complete. Only . . . if flying by himself is so wonderful, then why does he feel so empty?<br/>Because some experiences are better shared. (And penguins are much happier on the ground.)").__dict__
up_and_down['authors'].append({"last_name": o_jeffers['last_name'], "first_name": o_jeffers['first_name']})
up_and_down['genres'].append({"type": g_children_picture['type']})
book_catalog.append(up_and_down)

this_moose_belongs_to_me = CreateBook("This Moose Belongs to Me", "https://images.penguinrandomhouse.com/cover/9780399257377", "Wilfred is a boy with rules. He lives a very orderly life. It’s fortunate, then, that he has a pet who abides by rules, such as not making noise while Wilfred educates him on his record collection. There is, however, one rule that Wilfred’s pet has difficulty following: Going whichever way Wilfred wants to go. Perhaps this is because Wilfred’s pet doesn’t quite realize that he belongs to anyone.<br/>A moose can be obstinate in such ways.<br/>Fortunately, the two manage to work out a compromise. Let’s just say it involves apples.").__dict__
this_moose_belongs_to_me['authors'].append({"last_name": o_jeffers['last_name'], "first_name": o_jeffers['first_name']})
this_moose_belongs_to_me['genres'].append({"type": g_children_picture['type']})
book_catalog.append(this_moose_belongs_to_me)

stuck = CreateBook("Stuck", "https://images.penguinrandomhouse.com/cover/9780399257377", "From the illustrator of the #1 smash The Day the Crayons Quit comes another bestseller–a giggle-inducing tale of everything tossed, thrown, and hurled in order to free a kite!<br/>When Floyd’s kite gets stuck in a tree, he’s determined to get it out. But how? Well, by knocking it down with his shoe, of course. But strangely enough, it too gets stuck. And the only logical course of action . . . is to throw his other shoe. Only now it’s stuck! Surely there must be something he can use to get his kite unstuck. An orangutan? A boat? His front door? Yes, yes, and yes. And that’s only the beginning. Stuck is Oliver Jeffers’ most absurdly funny story since The Incredible Book-Eating Boy. Childlike in concept and vibrantly illustrated as only Oliver Jeffers could, here is a picture book worth rescuing from any tree.").__dict__
stuck['authors'].append({"last_name": o_jeffers['last_name'], "first_name": o_jeffers['first_name']})
stuck['genres'].append({"type": g_children_picture['type']})
book_catalog.append(stuck)

the_year_of_the_flood = CreateBook("The Year of the Flood", "https://images.penguinrandomhouse.com/cover/9780307455475", "Set in the visionary future of Atwood’s acclaimed Oryx and Crake, The Year of the Flood is at once a moving tale of lasting friendship and a landmark work of speculative fiction. In this second book of the MaddAddam trilogy, the long-feared waterless flood has occurred, altering Earth as we know it and obliterating most human life. Among the survivors are Ren, a young trapeze dancer locked inside the high-end sex club Scales and Tails, and Toby, who is barricaded inside a luxurious spa. Amid shadowy, corrupt ruling powers and new, gene-spliced life forms, Ren and Toby will have to decide on their next move, but they can’t stay locked away.").__dict__
the_year_of_the_flood['authors'].append({"last_name": m_atwood['last_name'], "first_name": m_atwood['first_name']})
the_year_of_the_flood['genres'].append({"type": g_literary_fiction['type']})
book_catalog.append(the_year_of_the_flood)

everythings_trash_but_its_okay = CreateBook("Everything’s Trash, But It’s Okay", "https://images.penguinrandomhouse.com/cover/9780525534143", "From New York Times bestselling author and star of 2 Dope Queens, Phoebe Robinson, comes a new, hilarious, and timely essay collection on gender, race, dating, and a world that seems to always be a self-starting Dumpster fire.<br/>Wouldn’t it be great if life came with instructions? Of course, but like access to Michael B. Jordan’s house, none of us are getting any. Thankfully, Phoebe Robinson is ready to share everything she has experienced to prove that if you can laugh at her topsy-turvy life, you can laugh at your own.<br/>Written in her trademark unfiltered and singularly witty style, Robinson’s latest essay collection is a call to arms. She tackles a wide range of topics, such as giving feminism a tough-love talk in hopes it can become more intersectional; telling society’s beauty standards to kick rocks; and takes a hard look at our culture’s obsession with work.<br/>Robinson also gets personal, exploring debt she has hidden from her parents, how dating is mainly a warmed-over bowl of hot mess, and maybe most importantly, meeting Bono not once, but twice. She’s struggled with being a woman with a political mind and a woman with an ever-changing jeans size. She knows about trash not only because she sees it every day, but also because she’s seen about one-hundred-thousand hours of reality TV and zero hours of Schindler’s List.<br/>Everything’s Trash, But It’s Okay is a candid perspective for a generation that has had the rug pulled out from under it too many times to count, as well as an intimate conversation with a new best friend.").__dict__
everythings_trash_but_its_okay['authors'].append({"last_name": p_robinson['last_name'], "first_name": p_robinson['first_name']})
everythings_trash_but_its_okay['genres'].append({"type": g_humor['type']})
everythings_trash_but_its_okay['genres'].append({"type": g_biography_memoir['type']})
book_catalog.append(everythings_trash_but_its_okay)

you_cant_touch_my_hair = CreateBook("You Can’t Touch My Hair", "https://images.penguinrandomhouse.com/cover/9780143129202", "A hilarious and timely essay collection about race, gender, and pop culture from comedy superstar and 2 Dope Queens podcaster Phoebe Robinson<br/>Being a black woman in America means contending with old prejudices and fresh absurdities every day. Comedian Phoebe Robinson has experienced her fair share over the years: she’s been unceremoniously relegated to the role of “the black friend,” as if she is somehow the authority on all things racial; she’s been questioned about her love of U2 and Billy Joel (“isn’t that…white people music?”); she’s been called “uppity” for having an opinion in the workplace; she’s been followed around stores by security guards; and yes, people do ask her whether they can touch her hair all. the. time. Now, she’s ready to take these topics to the page—and she’s going to make you laugh as she’s doing it.<br/>Using her trademark wit alongside pop-culture references galore, Robinson explores everything from why Lisa Bonet is “Queen. Bae. Jesus,” to breaking down the terrible nature of casting calls, to giving her less-than-traditional advice to the future female president, and demanding that the NFL clean up its act, all told in the same conversational voice that launched her podcast, 2 Dope Queens, to the top spot on iTunes. As personal as it is political, You Can’t Touch My Hair examines our cultural climate and skewers our biases with humor and heart, announcing Robinson as a writer on the rise.").__dict__
you_cant_touch_my_hair['authors'].append({"last_name": p_robinson['last_name'], "first_name": p_robinson['first_name']})
...
how_to_ruin_everything = CreateBook("How to Ruin Everything", "https://images.penguinrandomhouse.com/cover/9780147515995", "Are you a sensible, universally competent individual? Are you tired of the crushing monotony of leaping gracefully from one lily pad of success to the next? Are you sick of doing everything right?<br/>In this brutally honest and humorous debut, musician and artist George Watsky chronicles the small triumphs over humiliation that make life bearable and how he has come to accept defeat as necessary to personal progress. The essays in How to Ruin Everything range from the absurd (how he became an international ivory smuggler) to the comical (his middle-school rap battle dominance) to the revelatory (his experiences with epilepsy), yet all are delivered with the type of linguistic dexterity and self-awareness that has won Watsky devoted fans across the globe. Alternately ribald and emotionally resonant, How to Ruin Everything announces a versatile writer with a promising career ahead.").__dict__
how_to_ruin_everything['authors'].append({"last_name": g_watsky['last_name'], "first_name": g_watsky['first_name']})
...
based_on_a_true_story = CreateBook("Based on a True Story", "https://images.penguinrandomhouse.com/cover/9780812983869", "When Norm Macdonald, one of the greatest stand-up comics of all time, was approached to write a celebrity memoir, he flatly refused, calling the genre “one step below instruction manuals.” Norm then promptly took a two-year hiatus from stand-up comedy to live on a farm in northern Canada. When he emerged he had under his arm a manuscript, a genre-smashing book about comedy, tragedy, love, loss, war, and redemption. When asked if this was the celebrity memoir, Norm replied, “Call it anything you damn like.”").__dict__
based_on_a_true_story['authors'].append({"last_name": n_macdonald['last_name'], "first_name": n_macdonald['first_name']})
based_on_a_true_story['genres'].append({"type": g_humor['type']})
book_catalog.append(based_on_a_true_story)

lincoln = CreateBook("Lincoln", "https://images.penguinrandomhouse.com/cover/9780375708763", "Gore Vidal’s Narratives of Empire series spans the history of the United States from the Revolution to the post-World War II years. With their broad canvas and large cast of fictional and historical characters, the novels in this series present a panorama of the American political and imperial experience as interpreted by one of its most worldly, knowing, and ironic observers.<br/>To most Americans, Abraham Lincoln is a monolithic figure, the Great Emancipator and Savior of the Union, beloved by all. In Gore Vidal’s Lincoln we meet Lincoln the man and Lincoln the political animal, the president who entered a besieged capital where most of the population supported the South and where even those favoring the Union had serious doubts that the man from Illinois could save it. Far from steadfast in his abhorrence of slavery, Lincoln agonizes over the best course of action and comes to his great decision only when all else seems to fail. As the Civil War ravages his nation, Lincoln must face deep personal turmoil, the loss of his dearest son, and the harangues of a wife seen as a traitor for her Southern connections. Brilliantly conceived, masterfully executed, Gore Vidal’s Lincoln allows the man to breathe again.").__dict__
lincoln['authors'].append({"last_name": g_vidal['last_name'], "first_name": g_vidal['first_name']})
...
burr = CreateBook("Burr", "https://images.penguinrandomhouse.com/cover/9780375708732", "For readers who can’t get enough of the hit Broadway musical Hamilton, Gore Vidal’s stunning novel about Aaron Burr, the man who killed Alexander Hamilton in a duel—and who served as a successful, if often feared, statesman of our fledgling nation.<br/>Here is an extraordinary portrait of one of the most complicated—and misunderstood—figures among the Founding Fathers. In 1804, while serving as vice president, Aaron Burr fought a duel with his political nemesis, Alexander Hamilton, and killed him. In 1807, he was arrested, tried, and acquitted of treason. In 1833, Burr is newly married, an aging statesman considered a monster by many. But he is determined to tell his own story, and he chooses to confide in a young New York City journalist named Charles Schermerhorn Schuyler. Together, they explore both Burr’s past—and the continuing civic drama of their young nation.<br/>Burr is the first novel in Gore Vidal’s Narratives of Empire series, which spans the history of the United States from the Revolution to post-World War II. With their broad canvas and sprawling cast of fictional and historical characters, these novels present a panorama of American politics and imperialism, as interpreted by one of our most incisive and ironic observers.").__dict__
burr['authors'].append({"last_name": g_vidal['last_name'], "first_name": g_vidal['first_name']})
burr['genres'].append({"type": g_historical_fiction['type']})
burr['genres'].append({"type": g_literary_fiction['type']})
book_catalog.append(burr)

julian = CreateBook("Julian", "https://images.penguinrandomhouse.com/cover/9780375727061", "The remarkable bestseller about the fourth-century Roman emperor who famously tried to halt the spread of Christianity, Julian is widely regarded as one of Gore Vidal’s finest historical novels.<br/>Julian the Apostate, nephew of Constantine the Great, was one of the brightest yet briefest lights in the history of the Roman Empire. A military genius on the level of Julius Caesar and Alexander the Great, a graceful and persuasive essayist, and a philosopher devoted to worshipping the gods of Hellenism, he became embroiled in a fierce intellectual war with Christianity that provoked his murder at the age of thirty-two, only four years into his brilliantly humane and compassionate reign. A marvelously imaginative and insightful novel of classical antiquity, Julian captures the religious and political ferment of a desperate age and restores with blazing wit and vigor the legacy of an impassioned ruler.").__dict__
julian['authors'].append({"last_name": g_vidal['last_name'], "first_name": g_vidal['first_name']})
...
chike_and_the_river = CreateBook("Chike and the River", "https://images.penguinrandomhouse.com/cover/9780307473868", "Eleven-year-old Chike longs to cross the Niger River to the city of Asaba, but he doesn’t have the sixpence he needs to pay for the ferry ride. With the help of his friend S.M.O.G., he embarks on a series of adventures to help him get there. Along the way, he is exposed to a range of new experiences that are both thrilling and terrifying, from eating his first skewer of suya under the shade of a mango tree, to visiting the village magician who promises to double the money in his pocket. Once he finally makes it across the river, Chike realizes that life on the other side is far different from his expectations, and he must find the courage within him to make it home.<br/>Chike and the River is a magical tale of boundaries, bravery, and growth, by Chinua Achebe, one of the world’s most beloved and admired storytellers.").__dict__
chike_and_the_river['authors'].append({"last_name": c_achebe['last_name'], "first_name": c_achebe['first_name']})
chike_and_the_river['genres'].append({"type": g_literary_fiction['type']})
book_catalog.append(chike_and_the_river)

anthills_of_the_savannah = CreateBook("Anthills of the Savannah", "https://images.penguinrandomhouse.com/cover/9780385260459", "In the fictional West African nation of Kangan, newly independent of British rule, the hopes and dreams of democracy have been quashed by a fierce military dictatorship. Chris Oriko is a member of the president’s cabinet for life, and one of the leader’s oldest friends. When the president is charged with censoring the opportunistic editor of the state-run newspaper–another childhood friend–Chris’s loyalty and ideology are put to the test. The fate of Kangan hangs in the balance as tensions rise and a devious plot is set in motion to silence a firebrand critic.").__dict__
anthills_of_the_savannah['authors'].append({"last_name": c_achebe['last_name'], "first_name": c_achebe['first_name']})
anthills_of_the_savannah['genres'].append({"type": g_literary_fiction['type']})
book_catalog.append(anthills_of_the_savannah)

a_man_of_the_people = CreateBook("A Man of the People", "https://images.penguinrandomhouse.com/cover/9780385086165", "As Minister for Culture, former school teacher M. A. Nanga is a man of the people, as cynical as he is charming, and a roguish opportunist. When Odili, an idealistic young teacher, visits his former instructor at the ministry, the division between them is vast. But in the eat-and-let-eat atmosphere, Odili’s idealism soon collides with his lusts—and the two men’s personal and political tauntings threaten to send their country into chaos. When Odili launches a vicious campaign against his former mentor for the same seat in an election, their mutual animosity drives the country to revolution.<br/>Published, prophetically, just days before Nigeria’s first attempted coup in 1966, A Man of the People is an essential part of Achebe’s body of work.").__dict__
a_man_of_the_people['authors'].append({"last_name": c_achebe['last_name'], "first_name": c_achebe['first_name']})
a_man_of_the_people['genres'].append({"type": g_literary_fiction['type']})
book_catalog.append(a_man_of_the_people)

girls_at_war = CreateBook("Girls at War", "https://images.penguinrandomhouse.com/cover/9780385418966", "Twelve stories by the internationally renowned novelist which recreate with energy and authenticity the major social and political issues that confront contemporary Africans on a daily basis.").__dict__
girls_at_war['authors'].append({"last_name": c_achebe['last_name'], "first_name": c_achebe['first_name']})
girls_at_war['genres'].append({"type": g_literary_fiction['type']})
book_catalog.append(girls_at_war)

arrow_of_god = CreateBook("Arrow of God", "https://images.penguinrandomhouse.com/cover/9780385014809", "When Things Fall Apart ends, colonial rule has been introduced to Umuofia, and the character of the nation, its values, freedoms, religious and socio-political foundations have substantially and irrevocably been altered. Arrow of God, the second novel in Chinua Achebe’s The African Trilogy, moves the historical narrative forward. This time, the action revolves around Ezeulu, the headstrong chief priest of the god Ulu, which is worshipped by the six villages of Umuaro. The novel is a meditation on the nature, uses, and responsibility of power and leadership. Ezeulu finds that his authority is increasingly under threat from rivals within his nation and functionaries of the newly established British colonial government. Yet he sees himself as untouchable. He is forced, with tragic consequences, to reconcile conflicting impulses in his own nature—a need to serve the protecting deity of his Umuaro people; a desire to retain control over their religious observances; and a need to gain increased personal power by pushing his authority to the limits. He ultimately fails as he leads his people to their own destruction, and consequently, his personal tragedy arises. Arrow of God is an unforgettable portrayal of the loss of faith, and the downfall of a man in a society forever altered by colonialism.").__dict__
arrow_of_god['authors'].append({"last_name": c_achebe['last_name'], "first_name": c_achebe['first_name']})
...
the_autograph_man = CreateBook("The Autograph Man", "https://images.penguinrandomhouse.com/cover/9780375703874", "Alex-Li Tandem sells autographs. His business is to hunt for names on paper, collect them, sell them, and occasionally fake them—all to give the people what they want: a little piece of Fame. But what does Alex want? Only the return of his father, the end of religion, something for his headache, three different girls, infinite grace, and the rare autograph of forties movie actress Kitty Alexander. With fries.<br/>The Autograph Man is a deeply funny existential tour around the hollow trappings of modernity: celebrity, cinema, and the ugly triumph of symbol over experience. It offers further proof that Zadie Smith is one of the most staggeringly talented writers of her generation. Look for her new book Swing Time, coming November 2016.").__dict__
the_autograph_man['authors'].append({"last_name": z_smith['last_name'], "first_name": z_smith['first_name']})
the_autograph_man['genres'].append({"type": g_literary_fiction['type']})
book_catalog.append(the_autograph_man)

white_teeth = CreateBook("White Teeth", "https://images.penguinrandomhouse.com/cover/9780375703867", "Zadie Smith’s dazzling debut caught critics grasping for comparisons and deciding on everyone from Charles Dickens to Salman Rushdie to John Irving and Martin Amis. But the truth is that Zadie Smith’s voice is remarkably, fluently, and altogether wonderfully her own.").__dict__
white_teeth['authors'].append({"last_name": z_smith['last_name'], "first_name": z_smith['first_name']})
...
slaughterhouse_five = CreateBook("Slaughterhouse-Five", "https://images.penguinrandomhouse.com/cover/9780385333849", "Slaughterhouse-Five, an American classic, is one of the world’s great antiwar books. Centering on the infamous firebombing of Dresden, Billy Pilgrim’s odyssey through time reflects the mythic journey of our own fractured lives as we search for meaning in what we fear most. ").__dict__
slaughterhouse_five['authors'].append({"last_name": k_vonnegut['last_name'], "first_name": k_vonnegut['first_name']})
slaughterhouse_five['genres'].append({"type": g_literary_fiction['type']})
book_catalog.append(slaughterhouse_five)

the_sirens_of_titan = CreateBook("The Sirens of Titan", "https://images.penguinrandomhouse.com/cover/9780385333498", "The Sirens of Titan is an outrageous romp through space, time, and morality. The richest, most depraved man on Earth, Malachi Constant, is offered a chance to take a space journey to distant worlds with a beautiful woman at his side. Of course there’ s a catch to the invitation–and a prophetic vision about the purpose of human life that only Vonnegut has the courage to tell.").__dict__
the_sirens_of_titan['authors'].append({"last_name": k_vonnegut['last_name'], "first_name": k_vonnegut['first_name']})
...
the_underground_railroad['genres'].append({"type": g_historical_fiction['type']})
...
you_cant_spell_america_without_me['authors'].append({"last_name": a_baldwin['last_name'], "first_name": a_baldwin['first_name']})
you_cant_spell_america_without_me['authors'].append({"last_name": k_andersen['last_name'], "first_name": k_andersen['first_name']})
...
grant['authors'].append({"last_name": r_chernow['last_name'], "first_name": r_chernow['first_name']})
...
the_purloining_of_prince_oleomargarine['authors'].append({"last_name": m_twain['last_name'], "first_name": m_twain['first_name']})
the_purloining_of_prince_oleomargarine['authors'].append({"last_name": p_stead['last_name'], "first_name": p_stead['first_name']})
...
dragons_love_tacos = CreateBook("Dragons Love Tacos", "https://images.penguinrandomhouse.com/cover/9780803736801", "A #1 New York Times bestselling phenomenon, this deliciously funny read-aloud from the creators of Robo-Sauce and Secret Pizza Party will make you laugh until spicy salsa comes out of your nose.<br/>Dragons love tacos. They love chicken tacos, beef tacos, great big tacos, and teeny tiny tacos. So if you want to lure a bunch of dragons to your party, you should definitely serve tacos. Buckets and buckets of tacos. Unfortunately, where there are tacos, there is also salsa. And if a dragon accidentally eats spicy salsa . . . oh, boy. You’re in red-hot trouble.").__dict__
dragons_love_tacos['authors'].append({"last_name": a_rubin['last_name'], "first_name": a_rubin['first_name']})
dragons_love_tacos['authors'].append({"last_name": d_salmieri['last_name'], "first_name": d_salmieri['first_name']})
...
lidias_mastering_the_art_of_italian_cuisine['authors'].append({"last_name": l_bastianich['last_name'], "first_name": l_bastianich['first_name']})
lidias_mastering_the_art_of_italian_cuisine['authors'].append({"last_name": t_manuali['last_name'], "first_name": t_manuali['first_name']})
...
lidias_italy_in_america['authors'].append({"last_name": l_bastianich['last_name'], "first_name": l_bastianich['first_name']})
lidias_italy_in_america['authors'].append({"last_name": t_manuali['last_name'], "first_name": t_manuali['first_name']})
...
def add_book(book):
    ...
    for genre in book['genres']:
        try:
            genre_search = session.query(Genre).filter_by(type=genre['type']).first()
            if not genre_search:
    ...
    for author in book['authors']:
        try:
            author_search = session.query(Author).filter_by(last_name=author['last_name'], first_name=author['first_name']).first()
...
def add_authors(authors):
    for author in authors:
        new_author = Author(last_name=author['last_name'], first_name=author['first_name'], bio = author['bio'])
